...
export function gameLoopUpdateMethod(gameObjects, {GameState, PlayerState}, canvas, context, deltaTime, { collides }) {
  switch (GameState.currentState) {
    case GAME_STATE.MENU:
      updateMainMenu(gameObjects[GAME_STATE.MENU], {GameState, PlayerState}, canvas)
      break
    case GAME_STATE.LEVEL1:
      updateLevel1(gameObjects[GAME_STATE.LEVEL1], {GameState, PlayerState}, {canvas, context}, deltaTime, {collides})
      break
  }
}